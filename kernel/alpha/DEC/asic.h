 ...
 * HISTORY
 * $Log:	asic.h,v $
 * Revision 2.2  93/03/09  10:48:11  danner
...
#define	RESERVED_1		ASIC_SLOT_1_START+0x000
#define	RESERVED_2		ASIC_SLOT_1_START+0x010
...
#define	RESERVED_3		ASIC_SLOT_1_START+0x070
...
#define	RESERVED_4		ASIC_SLOT_1_START+0x170
#define	ASIC_SCC0_DECODE	ASIC_SLOT_1_START+0x180
#define	ASIC_SCC1_DECODE	ASIC_SLOT_1_START+0x190
#define	RESERVED_5		ASIC_SLOT_1_START+0x1a0
#define	RESERVED_6		ASIC_SLOT_1_START+0x1b0
#define	RESERVED_7		ASIC_SLOT_1_START+0x1c0
#define	RESERVED_8		ASIC_SLOT_1_START+0x1d0
...
#define ASIC_CSR_FAST_MODE	0x08000000	/* rw */ (0 = 25; 1 = 12.5 MHz)
#define ASIC_CSR_SINGLE_MODE	0x04000000	/* rw */ 
#define ASIC_CSR_SINGLE_BYTE1	0x02000000	/* rw */ 
#define ASIC_CSR_SINGLE_BYTE0	0x01000000	/* rw */ 
#define ASIC_CSR_xxx1		0x00800000	/* reserved */ 
#define ASIC_CSR_xxx2		0x00400000	/* reserved */ 
#define ASIC_CSR_xxx3		0x00200000	/* reserved */ 
#define ASIC_CSR_DMAEN_ISDN_T	0x00100000	/* rw */
#define ASIC_CSR_DMAEN_ISDN_R	0x00080000	/* rw */
#define ASIC_CSR_xxx4		0x00040000	/* reserved */
#define ASIC_CSR_xxx5		0x00020000	/* reserved */
#define ASIC_CSR_DMAEN_LANCE	0x00010000	/* rw */
#define ASIC_CSR_10BT_TEST_MODE	0x00008000	/* rw */
#define ASIC_CSR_ENET_LOOPBACK	0x00004000	/* rw */
#define ASIC_CSR_10BT_THICK_SEL	0x00002000	/* rw */
#define ASIC_CSR_79C30A_RESET	0x00001000	/* rw */
#define ASIC_CSR_SCC_RESET	0x00000800	/* rw */
#define ASIC_CSR_RTC_RESET	0x00000400	/* rw */
#define ASIC_CSR_xxx6		0x00000200	/* reserved */
#define ASIC_CSR_LANCE_RESET	0x00000100	/* rw */

/* bits 7:0 are used for the led's */
...
#define	ASIC_INTR_xxx1		0x00800000	/* reserved */
#define	ASIC_INTR_ISDN_T_PTR_LOAD	0x00400000	/* rz */
#define	ASIC_INTR_ISDN_R_PTR_LOAD	0x00200000	/* rz */
#define	ASIC_INTR_ISDN_OVRUN	0x00100000	/* rz */
#define	ASIC_INTR_xxx2		0x00080000	/* reserved */
#define	ASIC_INTR_xxx3		0x00040000	/* reserved */
#define	ASIC_INTR_xxx4		0x00020000	/* reserved */
