 ...
 * HISTORY
 * $Log:	vm_info.h,v $
 * Revision 2.8  93/01/14  17:49:38  danner
 * 	64bit cleanup.
 * 	[92/12/01            af]
 * 
 * Revision 2.7  92/01/14  16:45:56  rpd
 * 	Added VPI_STATE_PAGER.
 * 	Added voi_pagesize.
 * 	[92/01/04            rpd]
 * 
 * 	Replaced vm_info_region_t and vm_info_object_t with
 * 	vm_region_info_t, vm_object_info_t, vm_page_info_t.
 * 	[91/12/30            rpd]
 * 
