...
/* 
 * HISTORY
 * 24-Mar-94  David Golub (dbg) at Carnegie-Mellon University
 *	Moved kd_mouse_read and kd_mouse_write to i386at/kd_mouse.c.
 *
 * 11-Mar-94  David Golub (dbg) at Carnegie-Mellon University
 *	From Robert Baron:  set LEDS in kdinit after enabling keyboard,
 *	to keep NUM-LOCK from being set (on NEC Versa).
 *
 * $Log:	kd.c,v $
 ...
 * 	forward definition and define rebootflag as extern.  All for
 * 	gcc.
 * 	[89/03/04            rvb]
 * 
...
#include <com.h>
#if	NCOM > 0
#define	RCLINE	1			/* alternate console */
#else
#define	RCLINE	0
#endif
