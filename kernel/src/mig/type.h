 ...
 * HISTORY
 * $Log:	type.h,v $
 * Revision 2.10  93/11/17  18:49:55  dbg
 ...
 * 
 * Revision 2.9  93/05/10  17:50:05  rvb
 * 	Fix include to use < vs " for new ode shadowing
 * 	[93/05/10  10:29:38  rvb]
 * 
 * Revision 2.8  93/01/14  17:59:17  danner
...
typedef struct ipc_type
{
    ...
    u_int itAlignment;		/* address boundary to align (before) data */
...
extern ipc_type_t *itShortDecl(u_int inname, const_string_t instr,
			       ...
			       u_int defsize, u_int alignment);
extern ipc_type_t *itLongDecl(u_int inname, const_string_t instr,
			      u_int outname, const_string_t outstr,
			      u_int defsize, u_int size, u_int alignment,
			      ipc_flags_t flags);
...
extern u_int itAlignmentOf(u_int typename);
