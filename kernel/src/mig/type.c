...
/*	case MACH_MSG_TYPE_STRING_C:*/ return (0);

	case MACH_MSG_TYPE_INTEGER_16: return (16);
	case MACH_MSG_TYPE_INTEGER_32: return (32);
	case MACH_MSG_TYPE_INTEGER_64: return (64);
...
/*	case MACH_MSG_TYPE_PORT_RECEIVE:
	...
	case MACH_MSG_TYPE_POLYMORPHIC: return (word_size_in_bits);
